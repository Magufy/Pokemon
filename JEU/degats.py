    ...
    def tour(self):
        ...
        while action is None:
            ...
            if action == '1':
                choix=None
                while choix==None:
                    choix = input(f"""\033[0;94mChoisissez une attaque :
                                {self.poke_front.comp[0].nom} | 
                                {self.poke_front.comp[1].nom} | 
                                {self.poke_front.comp[2].nom} |
                                {self.poke_front.comp[3].nom} : \033[0""")
                ...
                while objet_util==None:
                    objet_util=input(f"""\033[0;94m Choisissez un objet : 
                                  ...
                                  8) {self.objets[7].nom} : {self.objets[7].nombre}\033[0""")
